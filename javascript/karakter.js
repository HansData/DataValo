...
function getHalamanCharacter() {
    ...
    <div class="peran-karakter">
        <h2 data-aos="fade-up" class="h2-peran-karakter font-judul">${sumber.role.displayName}</h2>
    <div class="logo-role-agen"></div>
    </div>
    <div class="ability-karakter">
    <ul>
        <li data-aos="fade-up" class="logo-ability logo-ability-click" data-id="0"><span class="span-atas"></span><span class="span-bawah"></span><img class="img-ability-click" src="${sumber.abilities[0].displayIcon}" alt="" /></li>
        <li data-aos="fade-down" class="logo-ability" data-id="1"><span class="span-atas"></span><span class="span-bawah"></span><img src="${sumber.abilities[1].displayIcon}" alt="" /></li>
        <li data-aos="fade-up" class="logo-ability" data-id="2"><span class="span-atas"></span><span class="span-bawah"></span><img src="${sumber.abilities[2].displayIcon}" alt="" /></li>
        <li data-aos="fade-down" class="logo-ability" data-id="3"><span class="span-atas"></span><span class="span-bawah"></span><img src="${sumber.abilities[3].displayIcon}" alt="" /></li>
    </ul>
        <h3 data-aos="fade-left" class="h3-ability-karakter font-subJudul">${sumber.abilities[0].displayName.toUpperCase()}</h3>

        <p data-aos="fade-right" class="p-ability-karakter font-isi">
